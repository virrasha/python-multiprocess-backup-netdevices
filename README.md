...
Script for parallel backup network devices. N backups in parallel. Result in mail. Repeat not successesd backups later. Commit in gitea.
...
To have history of changing configurations of network devices you also need version control system as GIT.
